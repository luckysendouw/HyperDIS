...
function createOrgs() {
  ...
  infoln "Generating CCP files for Org1, Org2, Org3, Org4, Org5, and Org6"
...
function networkDown() {
  ...
  DOCKER_SOCK=$DOCKER_SOCK docker-compose -f $COMPOSE_FILE_BASE -f $COMPOSE_FILE_CA down --volumes --remove-orphans
